...
export default function Profile() {
  return (
    <div className='box col-start-4 col-end-6 row-start-1 row-end-7 flex items-center justify-center hide-scrollbar overflow-y-auto relative py-4'>
      <div className='py-4 w-full h-11/12 flex flex-col gap-4 items-center justify-start'>
        <AvailableForWork />
