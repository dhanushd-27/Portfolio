  ...
  return (
    <div className='w-[842px] h-auto flex flex-col gap-6 items-center mt-[248px]'>
      ...
      <div className='flex gap-4'>
        <PrimaryBtn BtnName='Github' link='https://github.com/dhanushd-27'/>
        <SecondaryBtn BtnName='Resume' link='https://drive.google.com/file/d/12uwhzFC5pSiOtOCRU99P1SNKVwtUhnyS/view'/>
      </div>
    </div>
  )
}
