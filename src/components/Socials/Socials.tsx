...
export default function Links() {
  return (
    <div className='box col-start-4 col-end-6 row-start-7 row-end-11 flex flex-col gap-6 w-full'>
      <p className='header'>Find me on</p>
      <div className='flex flex-wrap w-full px-2 gap-5 justify-between hide-scrollbar overflow-y-auto'>
