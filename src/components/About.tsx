...
export default function About() {
  return (
    <div className='box col-start-6 col-end-10 row-start-1 row-end-7 flex flex-col gap-6'>
      ...
      <div className='text-text-default tracking-wide text-sm leading-6 text-justify px-4 flex flex-col gap-1'>
        ...
        <p className=''>
          I&apos;m currently exploring vertical scaling, containerization, and kubernetes to deepen my backend and DevOps knowledge.
        </p>
        <p className=''>
